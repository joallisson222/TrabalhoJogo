...
var Questions =
{
    ...
    q1:
    {
        ...
        opt3: "o glicogênio e o amido são polissacarídeos produzidos pelas células vegetais. ", //option 3
        opt4: "os triglicerídeos e polissacarídeos são carboidratoso", //option 4
    ...
    q3:
    {
        ...
        text: "III- A replicação do DNA é conservativa",
        opt1: "Apenas II está correta ", //option 1
        opt2: "Apenas I e III estão corretas", //option 2
    ...
    q4:
    {
        ...
        opt3: "Na transcrição reversa desse RNA para DNA", //option 3
        opt4: "Na autoduplicação do DNA que o originou.", //option 4
    ...
    q5:
    {
        ...
        opt3: "Ao conjunto de trincas de bases nitrogenadas, cada trinca correspondida a um determinado aminoácido..", //option 3
        opt4: "Ao conjunto de todos os genes dos cromossomos de uma célula, capazes de sintetizar diferentes proteínas .", //option 4
        rightOpt: 3 //right option
    },
    q6:
    {
        ...
        opt3: "CGTACCAGTAGT.", //option 3
        opt4: "GCATGGTCATAC", //option 4
        rightOpt: 2 //right option
    },
    q7:
    {
        ...
        opt3: "A molécula de RNA possui aspecto de dupla hélice, e, tal como ocorre no DNA, as duas cadeias de nucleotídeos são mantidas unidas por pontes de hidrogênio", //option 3
        opt4: "As bases nitrogenadas do RNA são as mesmas do DNA: adenina, guanina, timina e citosina.", //option 4
        rightOpt: 2 //right option
    },
    q8:
    {
        ...
        opt2: "Códon.", //option 2
        opt3: "Nucleotídeo.", //option 3
        opt4: "Triplete.", //option 4
        rightOpt: 2 //right option
    },
    q9:
    {
    ...
    q10:
    {
        ...
        opt3: "é degenerado", //option 3
        opt4: "é o DNA e o RNA", //option 4
        rightOpt: 3 //right option
    }
};
